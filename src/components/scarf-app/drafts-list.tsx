        ...
        <div className="max-h-[400px] overflow-y-auto space-y-3 my-4">
          {drafts.length === 0 ? (
            ...
            drafts.map((draft) => (
              <div 
                key={draft.id} 
                className="p-4 border rounded-2xl flex items-center justify-between hover:bg-muted transition-colors"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <p className="font-bold text-foreground font-mono text-sm">{draft.id}</p>
